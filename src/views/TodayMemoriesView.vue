...
import { fetchTodayMemories, type AdminMemory } from '@/api/adminApi'
...
onMounted(async () => {
  loading.value = true
  try {
    memories.value = await fetchTodayMemories()
  } catch {
    error.value = true
  } finally {
    loading.value = false
  ...
  <div class="page">
    ...
    <main class="content">
      <div class="page-header">
        <h2 class="page-title">오늘 생성 기억 목록</h2>
        <p class="page-subtitle">오늘 생성된 기억을 조회합니다</p>
      </div>
        ...
        <table class="data-table">
          ...
          <tbody>
            <tr v-if="memories.length === 0">
              <td colspan="7" class="empty-cell">오늘 생성된 기억이 없습니다.</td>
            </tr>
